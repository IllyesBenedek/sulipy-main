...
bird = pygame.image.load("Irányítás_és_ütközés/Irányítás_billentyűzettel/img/bird1.png").convert_alpha()
bird_x = WIDTH / 2
bird_y = HEIGHT / 2
...
while running:
    ...
    if keys[pygame.K_RIGHT] and bird_rect.right <= WIDTH:
        ...
        bird = pygame.image.load("Irányítás_és_ütközés/Irányítás_billentyűzettel/img/bird1_back.png").convert_alpha()
        bird_x -= SPEED
